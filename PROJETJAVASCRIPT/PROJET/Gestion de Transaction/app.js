const clients = [
    { nom: "Diop", Prenom: "Babacar", telephone: "771234564", mail: "diop@gmail.com", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=6", paiement: [12000, 12000, 12000], sens: [1, -1, 1], day: ["12/01/2023", "13/01/2023", "01/02/2023"] },
    { nom: "Dieng", Prenom: "Khady", telephone: "771234567", mail: "khady@gmail.com", photo: 'https://images.unsplash.com/photo-1579610520129-963c74781ffb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=714&q=80', paiement: [12000, 12000, 12000, 12000, 12000], sens: [1, 1, 1, -1, -1], day: ["12/01/2023", "13/01/2023", "15/01/2023", "20/01/2023", "30/01/2023"] },
    { nom: "Sagna", Prenom: "Moussa", telephone: "760234567", mail: "moussag@gmail.com", photo: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60", paiement: [12000, 12000, 12000], sens: [-1, 1, 1], day: ["12/01/2023", "13/01/2023", "10/02/2023"] },
    { nom: "Ndiaye", Prenom: "Fallou", telephone: "709846763", mail: "Fallou@gmail.com", photo: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60", paiement: [12000, 12000, 12000], sens: [-1, 1, 1,], day: ["12/01/2023", "13/01/2023", "23/02/2023"] },
    { nom: "Mboup", Prenom: "Babacar", telephone: "764678760", mail: "mboup@gmail.com", photo: "https://images.unsplash.com/photo-1619182597083-17bda72c1d56?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=368&q=80", paiement: [12000], sens: [1], day: ["12/01/2023"] },
    { nom: "Silvestre", Prenom: "Berthe", telephone: "751234567", mail: "berthe@gmail.com", photo: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8d29tYW4lMjBmYWNlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60", paiement: [12000, 12000, 12000, 12000], sens: [1, 1, -1, 1], day: ["12/01/2023", "13/01/2023", "20/01/2023", "28/02/2023"] },
    { nom: "Ba", Prenom: "Aliou", telephone: "774221268", mail: "Aliou@gmail.com", photo: "https://media.istockphoto.com/id/544358212/photo/happy-laughing-man.jpg?s=612x612&w=is&k=20&c=TeWwYilpBKQqFFbpN3U1t6e7lCSTvKCdrYyAtx54AbM=", paiement: [12000, 12000, 12000, 12000, 1000], sens: [1, 1, -1, 1, 1], day: ["12/01/2023", "13/01/2023", "15/01/2023", "20/01/2023", "12/02/2023"] }
    ...
    for (let i = 0; i < tabIndiceTransact.length; i++) {
        if (ind === tabIndiceTransact[i].inDeb) {
            ...
            if (sol < tabIndiceTransact[i].montant) {
                messError(divError, "Desole Le client à deja retiré l'argent");
            }
            else {
                ...
                messError(divError, "transaction Annulé");
...
function RechercheUser(motCherche) {
 ...
 //Détecter le transfert d'un utilisateur vers un autre
let transferredUser =  [
    { nom: "Diop", Prenom: "Babacar", telephone: "771234564", mail: "diop@gmail.com", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=6", paiement: [12000, 12000, 12000], sens: [1, -1, 1], day: ["12/01/2023", "13/01/2023", "01/02/2023"] },
    { nom: "Dieng", Prenom: "Khady", telephone: "771234567", mail: "khady@gmail.com", photo: 'https://images.unsplash.com/photo-1579610520129-963c74781ffb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=714&q=80', paiement: [12000, 12000, 12000, 12000, 12000], sens: [1, 1, 1, -1, -1], day: ["12/01/2023", "13/01/2023", "15/01/2023", "20/01/2023", "30/01/2023"] },
    { nom: "Sagna", Prenom: "Moussa", telephone: "760234567", mail: "moussag@gmail.com", photo: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60", paiement: [12000, 12000, 12000], sens: [-1, 1, 1], day: ["12/01/2023", "13/01/2023", "10/02/2023"] },
...
// Récupérer l'utilisateur qui a reçu le transfert
let receivingUser = [
    { nom: "Diop", Prenom: "Babacar", telephone: "771234564", mail: "diop@gmail.com", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=6", paiement: [12000, 12000, 12000], sens: [1, -1, 1], day: ["12/01/2023", "13/01/2023", "01/02/2023"] },
    { nom: "Dieng", Prenom: "Khady", telephone: "771234567", mail: "khady@gmail.com", photo: 'https://images.unsplash.com/photo-1579610520129-963c74781ffb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=714&q=80', paiement: [12000, 12000, 12000, 12000, 12000], sens: [1, 1, 1, -1, -1], day: ["12/01/2023", "13/01/2023", "15/01/2023", "20/01/2023", "30/01/2023"] },
    { nom: "Sagna", Prenom: "Moussa", telephone: "760234567", mail: "moussag@gmail.com", photo: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8bWFuJTIwZmFjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60", paiement: [12000, 12000, 12000], sens: [-1, 1, 1], day: ["12/01/2023", "13/01/2023", "10/02/2023"] },
...
let notification = new Notification("Nouveau transfert reçu", {
  body: transferredUser.solde + " a été transféré de " + transferredUser.prenom + " à votre compte",
  icon: "path/to/notification-icon.png"
});

// Demander l'autorisation à l'utilisateur pour afficher une notification
Notification.requestPermission().then(function(permission) {
  // Si l'utilisateur accepte, afficher la notification
